...
$publisher = "ChyguiSlide"
$groupName = "ChyguiSlide"
...
# Формируем defines построчно для контроля кодировки
$lines = @(
    ...
    "  #define MyAppGroupName ""$groupName""",
    "#endif"
)

# Записываем в UTF-8 с BOM для совместимости с Inno Setup
[System.IO.File]::WriteAllLines($DefinesPath, $lines, $utf8Bom)
